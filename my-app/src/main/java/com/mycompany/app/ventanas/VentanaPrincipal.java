...
public class VentanaPrincipal extends JFrame {
	...
	JLabel lblNombreUser, lblEneko, lblAitor, lblErik, lblIratxe, lblEstadistica, lblRegistrarLocal, lblNombreLocal,
	...
	public VentanaPrincipal(Users us) {
		...
		// Creacion del panel superior derecho con el boton de logout y nombre de
		// usuario
		...
		lblBienvenidaSelect.setBounds(panelBienvenida.getWidth() / 2 - 80, panelBienvenida.getHeight() / 2 + 30, 280,
				30);
		panelBienvenida.add(lblBienvenidaSelect);

		if (!panelCrearTicket.isVisible() && !panelVerTickets.isVisible() && !panelVerEstadisticas.isVisible()
				&& !panelVerProductos.isVisible()) {
			add(panelBienvenida);
